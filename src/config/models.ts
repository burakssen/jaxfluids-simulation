...
export const MODEL_FAMILIES: Record<string, ModelFamily> = {
  linear_advection: {
    ...
    variants: [
      {
        ...
        modelPath:
          "/jaxfluids-simulation/models/linear_advection_v1/model_slim.onnx",
      ...
      },
      {
        ...
        modelPath:
          "/jaxfluids-simulation/models/linear_advection_v2/model_slim.onnx",
        inputShape: [5, 256, 1, 1],
        outputShape: [5, 256, 1, 1],
    ...
    data: [
      {
        path: "/jaxfluids-simulation/models/linear_advection_v1/data.npy",
        name: "Data v1",
        yAxisDomain: [0.0, 2.75],
      },
      {
        path: "/jaxfluids-simulation/models/linear_advection_v2/data.npy",
        name: "Data v2",
  ...
  sod_shock_tube: {
    ...
    variants: [
      {
        ...
        modelPath:
          "/jaxfluids-simulation/models/sod_shock_tube/weno5-z/model_slim.onnx",
      ...
      },
      {
        ...
        modelPath:
          "/jaxfluids-simulation/models/sod_shock_tube/weno5-js/model.onnx",
        inputShape: [5, 200, 1, 1],
        outputShape: [5, 200, 1, 1],
        timeStepRange: [0.0001, 0.001],
        defaultTimeStep: 0.0001,
      },
      {
        ...
        modelPath:
          "/jaxfluids-simulation/models/sod_shock_tube/weno3-js/model.onnx",
        inputShape: [5, 200, 1, 1],
        outputShape: [5, 200, 1, 1],
        timeStepRange: [0.0001, 0.001],
        defaultTimeStep: 0.0001,
    ...
    data: [
      {
        path: "/jaxfluids-simulation/models/sod_shock_tube/data/data_v1.npy",
        name: "Data v1",
        yAxisDomain: [-0.25, 1.25],
      },
      {
        path: "/jaxfluids-simulation/models/sod_shock_tube/data/data_v2.npy",
        name: "Data v2",
        yAxisDomain: [-0.5, 2.5],
      },
      {
        path: "/jaxfluids-simulation/models/sod_shock_tube/data/data_v3.npy",
        name: "Data v3",
        yAxisDomain: [-5.0, 105.0],
      },
      {
        path: "/jaxfluids-simulation/models/sod_shock_tube/data/data_v4.npy",
        name: "Data v4",
        yAxisDomain: [-0.25, 1.25],
      },
      {
        path: "/jaxfluids-simulation/models/sod_shock_tube/data/data_v5.npy",
        name: "Data v5",
        yAxisDomain: [-0.25, 1.25],
      },
    ],

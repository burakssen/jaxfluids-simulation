...
export const MODEL_CONFIGS: ModelConfig[] = [
  {
    ...
    modelPath: "/jaxfluids-feed-forward/linear_advection_v1/model_slim.onnx",
    datas: [
      {
        path: "/jaxfluids-feed-forward/linear_advection_v1/data.npy",
  ...
  },
  {
    ...
    modelPath: "/jaxfluids-feed-forward/linear_advection_v2/model_slim.onnx",
    datas: [
      {
        path: "/jaxfluids-feed-forward/linear_advection_v2/data.npy",
        name: "Linear Advection Data",
      },
    ],
    inputShape: [5, 256, 1, 1],
  ...
  },
  {
    ...
    modelPath: "/jaxfluids-feed-forward/sod_shock_tube/model_slim.onnx",
    datas: [
      {
        path: "/jaxfluids-feed-forward/sod_shock_tube/data/data_v1.npy",
        name: "Sod Shock Tube Data v1",
      },
      {
        path: "/jaxfluids-feed-forward/sod_shock_tube/data/data_v2.npy",
        name: "Sod Shock Tube Data v2",
      },
      {
        path: "/jaxfluids-feed-forward/sod_shock_tube/data/data_v3.npy",
